...
namespace Autohand{
    ...
    public class PlacePoint : MonoBehaviour{
        ...
        public virtual void Place(Grabbable placeObj) {
            ...
            //placeObj.gameObject.GetComponent<Collider>().enabled = false;
            //placeObj.gameObject.GetComponent<SphereCollider>().enabled = false;
        }
        ...
        public virtual void Remove(Grabbable placeObj) {
            ...
            //placeObj.gameObject.GetComponent<Collider>().enabled = true;
            //placeObj.gameObject.GetComponent<SphereCollider>().enabled = true;
        }
