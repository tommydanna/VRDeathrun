...
namespace Autohand {
    ...
    public class Hand : MonoBehaviour {
       ...
       /*[Header("UI References"), Space, Space]
        public GameObject headerCanvas;
        public GameObject settingsButton;
        public GameObject helpButton;
        public GameObject spellpaternsButton;
        public GameObject potionsButton;
        public GameObject roomButton;
        public GameObject headerPanel;
        public GameObject itemWheelPanel;
        public GameObject wandButton;
        public GameObject bookButton;
        public GameObject handsButton;
        
        //home pages
        public GameObject homePage1Panel;
        public GameObject playerListItem;
        public GameObject playerListBackgroundImage;
        public GameObject tooltip;
        public GameObject homePage2Panel;
        ...
        */
        ...
        public void Start() {
            ...
            //Sets layers to default if grabbables set to none on start -- Feel free to delete
        ...
        public virtual void Initialize() {
            ...
            //headerCanvas.layer = LayerMask.NameToLayer("UI");
            //headerPanel.layer = LayerMask.NameToLayer("UI");
            //settingsButton.layer = LayerMask.NameToLayer("UI");
            //helpButton.layer = LayerMask.NameToLayer("UI");
            //spellpaternsButton.layer = LayerMask.NameToLayer("UI");
            //potionsButton.layer = LayerMask.NameToLayer("UI");
            //roomButton.layer = LayerMask.NameToLayer("UI");
            //itemWheelPanel.layer = LayerMask.NameToLayer("UI");
            //wandButton.layer = LayerMask.NameToLayer("UI");
            //bookButton.layer = LayerMask.NameToLayer("UI");
            //handsButton.layer = LayerMask.NameToLayer("UI");
            //homePage1Panel.layer = LayerMask.NameToLayer("UI");
            //playerListItem.layer = LayerMask.NameToLayer("UI");
            //playerListBackgroundImage.layer = LayerMask.NameToLayer("UI");
            //tooltip.layer = LayerMask.NameToLayer("UI");
            //homePage2Panel.layer = LayerMask.NameToLayer("UI");
            //disconnectButton.layer = LayerMask.NameToLayer("UI");
            //yesButton.layer = LayerMask.NameToLayer("UI");
            //noButton.layer = LayerMask.NameToLayer("UI");
            //abandonButton.layer = LayerMask.NameToLayer("UI");
        ...
        protected virtual void CheckHighlight() {
            if(highlightLayers != 0 && holdingObj == null){
                Grabbable lookingAtGrab;
                RaycastHit hit;
        ...
        protected virtual void LookAssist(){
            if(holdingObj == null){
                ...
                var dir = HandClosestHit(follow, controllerRot, out hit, reachDistance, grabLayers);
